...
All functions return true/false for success, real return values are given through parameters.
*/
...
giving the UUID's.
Then, they provide fn, the aforementioned function, which takes a list of values (all uint64_t's). The function generates a feature of
size n_bytes_ret.
...
*/
bool fstore_query_past(combiner_id_t id, int n_past, void** val);
